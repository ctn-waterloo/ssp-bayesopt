...
class SamplingTrial(pytry.Trial):
    ...
    def evaluate(self, p):
        ...
        vals = np.zeros((budget+num_init_samples,))
        sample_locs = []
        ...
        return dict(
            ...
            full_times=optimizer.full_times, # includes decoding
...
if __name__ == '__main__':
    ...
    if args.nengo:
        data_path = os.path.join(os.getcwd(),
                                 args.data_dir, args.task_id, 'ssp-mcbo_nengo-' + args.backend)
    else:
        data_path = os.path.join(os.getcwd(),
                                 args.data_dir, args.task_id, 'ssp-mcbo')

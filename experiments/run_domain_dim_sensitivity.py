...
class SamplingTrial(pytry.Trial):
    def params(self):
        self.param('function', function_name='rosenbrock')
        self.param('function_dim', function_dim=2)
...
if __name__=='__main__':
    ...
    parser.add_argument('--func', dest='function_name', type=str, default='rosenbrock')
    parser.add_argument('--func-dim', dest='function_dim', type=int, default=2)
